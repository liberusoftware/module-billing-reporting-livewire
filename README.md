...
[![Latest release](https://img.shields.io/github/v/release/liberusoftware/module-billing-reporting-livewire?sort=semver)](https://github.com/liberusoftware/module-billing-reporting-livewire/releases/latest) [![Tests](https://github.com/liberusoftware/module-billing-reporting-livewire/actions/workflows/tests.yml/badge.svg?branch=main)](https://github.com/liberusoftware/module-billing-reporting-livewire/actions/workflows/tests.yml)
...
```bash
composer require liberusoftware/module-billing-reporting-livewire
```
...
<a href="https://github.com/liberusoftware/module-billing-reporting-livewire/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=liberusoftware/module-billing-reporting-livewire" alt="Contributors to liberusoftware/module-billing-reporting-livewire">
</a>

[View the full contributors graph](https://github.com/liberusoftware/module-billing-reporting-livewire/graphs/contributors).
